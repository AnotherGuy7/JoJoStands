...
namespace JoJoStands.Projectiles.PlayerStands.Mandom
{ 
	public class MandomStandT1 : StandClass
	{
        ...
        public override void PlayAnimation(string animationName)
        {
            if (Main.netMode != NetmodeID.Server)
                standTexture = (Texture2D)ModContent.Request<Texture2D>("JoJoStands/Projectiles/PlayerStands/Mandom/Mandom_" + animationName);
