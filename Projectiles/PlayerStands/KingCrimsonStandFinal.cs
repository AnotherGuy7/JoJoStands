...
{
    public class KingCrimsonStandFinal : ModProjectile      //has 2 poses
    {
        ...
        public int punchDamage = 186;
        public float punchKnockback = 5f;
        public int shootCount = 0;
        public int punchTime = 20;      //KC's punch timings are based on it's frame, so punchTime has to be 3 frames longer than the duration of the frame KC punches in
