...
{
    public class KingCrimsonStandT3 : ModProjectile      //has 2 poses
    {
        ...
        public int punchDamage = 124;
        public float punchKnockback = 4f;
        public int shootCount = 0;
        public int punchTime = 22;      //KC's punch timings are based on it's frame, so punchTime has to be 3 frames longer than the duration of the frame KC punches in
