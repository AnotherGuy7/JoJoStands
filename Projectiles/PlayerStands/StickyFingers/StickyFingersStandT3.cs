        ...
        public override void AI()
        {
            ...
            if (!mPlayer.standAutoMode)
            {
                ...
                if (SpecialKeyPressed() && shootCount <= 0 && !secondaryAbility && player.ownedProjectileCounts[ModContent.ProjectileType<StickyFingersZipperPoint>()] == 0)
                {
                    ...
                    int proj = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, shootVel, ModContent.ProjectileType<StickyFingersZipperPoint>(), 0, 0f, Projectile.owner, 0f);
                    Main.projectile[proj].netUpdate = true;
                    Projectile.netUpdate = true;
                }
            }
