    ...
    public class GoldAmuletOfAdapting : ModItem
    {
        ...
        public override bool CanEquipAccessory(Player player, int slot, bool modded)
        {
            ...
            for (int i = 0; i < player.armor.Length; i++)
            {
                ...
                if (Item.type == ModContent.ItemType<PlatinumAmuletOfAdapting>())
                {
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<GreaterGoldAmuletOfEscape>())
                .AddIngredient(ModContent.ItemType<GreaterGoldAmuletOfChange>())
