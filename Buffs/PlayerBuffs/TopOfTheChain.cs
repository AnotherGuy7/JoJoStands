...
namespace JoJoStands.Buffs.PlayerBuffs
{
    public class TopOfTheChain : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            player.allDamageMult *= 1.1f + (2f * (vPlayer.GetSkillLevel(player, VampirePlayer.TopOfTheChain) - 1));
            player.jumpSpeedBoost *= 1.15f + (1.5f * (vPlayer.GetSkillLevel(player, VampirePlayer.TopOfTheChain) - 1));
