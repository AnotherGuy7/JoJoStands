...
using JoJoStands.Items.Armor.VampirismArmors.RustedGladiator;
...
namespace JoJoStands.NPCs.Enemies
{
    public class GladiatorZombie : ModNPC
    {
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<RustedGladiatorHelmet>(), 15));
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<RustedGladiatorChestplate>(), 15));
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<RustedGladiatorBoots>(), 15));
        }
