    ...
    public class MarineBiologist : ModNPC
    {
        ...
        public override void OnChatButtonClicked(bool firstButton, ref bool openShop)
        {
            ...
            if (firstButton)
            {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<StarPlatinumT1>() || mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<StarPlatinumT2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<StarPlatinumT3>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<StarPlatinumFinal>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<HierophantGreenT1>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<HierophantGreenT2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<HierophantGreenT3>() || mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<HierophantGreenFinal>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<TheWorldT1>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<TheWorldT2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<TheWorldT3>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<TheWorldFinal>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<KillerQueenT1>() || mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<KillerQueenT2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<KillerQueenT3>() || mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<KillerQueenFinal>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<KillerQueenBTD>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<AchtungBaby>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<GoldExperienceT1>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<GoldExperienceT2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<GoldExperienceT3>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<GoldExperienceFinal>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<GoldExperienceRequiem>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<TuskAct1>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<TuskAct2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<TuskAct3>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<StickyFingersT1>() || mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<StickyFingersT2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<StickyFingersT3>() || mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<StickyFingersFinal>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<SexPistolsT1>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<SexPistolsT2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<SexPistolsT3>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<SexPistolsFinal>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<KingCrimsonT1>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<KingCrimsonT2>())
                {
                ...
                if ((mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<KingCrimsonT3>() || mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<KingCrimsonFinal>()))
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<CenturyBoyT1>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<CenturyBoyT2>())
                {
                ...
                if (player.HeldItem.type == ModContent.ItemType<DollyDaggerT1>())
                {
                    Main.npcChatText = "Intel from the SPW suggests that this stand merely reflects 35% of damage taken.";
                }
                if (player.HeldItem.type == ModContent.ItemType<DollyDaggerT2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<MagiciansRedT1>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<MagiciansRedT2>())
                {
                ...
                if ((mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<MagiciansRedT3>() || mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<MagiciansRedFinal>()))
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<AerosmithT1>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<AerosmithT2>())
                {
                    Main.npcChatText = "Now, Aerosmith can drop bombs on your enemies. Light them up brighter than before!";
                }
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<AerosmithT3>() || mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<AerosmithFinal>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<TheHandT1>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<TheHandT2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<TheHandT3>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<TheHandFinal>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<GratefulDeadT1>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<GratefulDeadT2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<GratefulDeadT3>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<GratefulDeadFinal>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<LockT1>() || mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<LockT2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<LockT3>() || mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<LockFinal>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<WhitesnakeT1>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<WhitesnakeT2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<WhitesnakeT3>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<WhitesnakeFinal>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<SilverChariotT1>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<SilverChariotT2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<SilverChariotT3>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<SilverChariotFinal>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<CreamT1>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<CreamT2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<CreamT3>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<CreamFinal>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<HermitPurpleT1>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<HermitPurpleT2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<HermitPurpleT3>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<HermitPurpleFinal>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<BadCompanyT1>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<BadCompanyT2>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<BadCompanyT3>())
                {
                ...
                if (mPlayer.StandSlot.SlotItem.type == ModContent.ItemType<BadCompanyFinal>())
                {
